...
import com.example.handheld.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.establishContact.setOnClickListener {
            if (!wearableDeviceConnected) {
                val tempAct: Activity = activityContext as MainActivity
                //Couroutine
                initializePairing(tempAct)
            }
        }
...
//        })
    ...
    @SuppressLint("SetTextI18n")
    private fun initializePairing(tempAct: Activity){
        ...
        if (wearableDeviceConnected) {
            ...
            sendMessageTask.addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    sbTemp.append("\n")
                    sbTemp.append(binding.statusText.text.toString())
                    sbTemp.append(" (Sent to Wearable)")
                    Log.d("receive1", " $sbTemp")
                    binding.dataText.append(sbTemp)
        ...
        try {
            ...
            if (messageEventPath == APP_OPEN_WEARABLE_PAYLOAD_PATH) {
                ...
                try {
                    ...
                    Log.d("receive1", " $sbTemp")
                    binding.statusText.append(sbTemp)
